Shader "Toon/ToonShader"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float _RimPower, _RimStep, _SpPower;
            ...
            fixed4 frag (v2f i) : SV_TARGET {
                ...
                float3 faceXDir = mul(UNITY_MATRIX_M, float4(1,0,0,0)).xyz;
                float3 faceYDir = mul(UNITY_MATRIX_M, float4(0,1,0,0)).xyz;
                float3 faceZDir = mul(UNITY_MATRIX_M, float4(0,0,1,0)).xyz;
